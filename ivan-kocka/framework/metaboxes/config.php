...
if ( !function_exists( "ivan_redux_add_metaboxes" ) ) :
	...
	$boxSections[] = array(
		...
		'fields' => array(
			...
			array(
				'id'=>'header-hide-scroll-switch-local',
				'type'	 => 'button_set',
				'title' => __('Hide Header when Scrolling Down?', 'ivan_domain_redux'),
				'subtitle'=> __('If on, the sticky header will be hidden when scrolling down and shown when scrolling top.', 'ivan_domain_redux'),
				//Must provide key => value pairs for options
				'options' => array(
					'1' => 'On',
					'' => 'Default',
	...
	$boxSections[] = array(
		...
		'fields' => array(
			...
			array(
				'id'=>'title-sep-enable-local',
				'type'	 => 'button_set',
				'title' => __('Enable Separator?', 'ivan_domain_redux'),
				'subtitle'=> __('If on, a separator will be displayed below title.', 'ivan_domain_redux'),
				//Must provide key => value pairs for options
				'options' => array(
					'1' => 'On',
					'' => 'Default',
			...
			array(
				'id' => 'title-sub-text-top',
				'type' => 'textarea',
				'title' => __('Title Optional Top Description', 'ivan_domain_redux'),
				'subtitle' => __('You can use a, strong, br, em and strong HTML tags.', 'ivan_domain_redux'),
				'description' => __('Use this field to display an optional text above main page title.', 'ivan_domain_redux'),
				'validate' => 'html_custom',
				'allowed_html' => array(
						'a' => array(
							'href' => array(),
