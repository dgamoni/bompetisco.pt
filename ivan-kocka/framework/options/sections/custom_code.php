...
$this->sections[] = array(
	...
	'fields' => array(
		...
		array(
		    ...
		    'subtitle' => __('Insert your custom CSS code right here. It will be displayed globally in the website.<br><strong>Do not include &lt;style> tag.</strong>', 'ivan_domain_redux'),
		    'mode'     => 'css',
		    'theme'    => 'monokai',
		    'desc'     => '',
		    'default'  => ""
		...
		array(
		    ...
		    'subtitle' => __('Insert your custom JS code right here. It will be displayed globally in the website.<br><strong>Do not include &lt;script> tag.</strong>', 'ivan_domain_redux'),
		    'mode'     => 'javascript',
		    'theme'    => 'monokai',
		...
		array(
		    ...
		    'description' => __('You can insert aside link tags from Google Fonts, favicon code. We recommend this website to generate optimal markup:', 'ivan_domain_redux') . ' <a href="' . esc_url('http://realfavicongenerator.net/') .'" target="_blank">Real Favicon Generator</a>', 
