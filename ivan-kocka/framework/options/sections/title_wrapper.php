...
$this->sections[] = array(
	...
	'fields' => array(
		...
		*/
		...
		array(
			'id' => 'title-desc-blog-top',
			'type' => 'textarea',
			'title' => __('Default Blog Top Description', 'ivan_domain_redux'),
			'subtitle' => __('Place any text or shortcode to be displayed above blog title.', 'ivan_domain_redux'),
			'validate' => 'html_custom',
			'allowed_html' => array(
					'a' => array(
						'href' => array(),
		...
		array(
			'id' => 'title-desc-shop-top',
			'type' => 'textarea',
			'title' => __('Default Shop Top Description', 'ivan_domain_redux'),
			'subtitle' => __('Place any text or shortcode to be displayed above shop title.', 'ivan_domain_redux'),
			'validate' => 'html_custom',
			'allowed_html' => array(
					'a' => array(
						'href' => array(),
