	...
	<div class="lwa-in">
		...
		<div class="lwa-info">
			...
			<?php
				...
				if( true == is_woocommerce_activated() ) {
					?>
					<li><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?><?php echo get_option('woocommerce_myaccount_edit_account_endpoint'); ?>/"><?php _e('Profile','ivan_domain') ?></a></li>
					<?php
				} else {
