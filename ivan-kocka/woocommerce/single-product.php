...
<?php
if( ivan_get_option('woo-product-enable-title') OR ( true == ivan_get_option( 'header-negative-height' ) && false == ivan_get_option('woo-disable-title') ) ) :
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				...
				if( ivan_get_option('title-desc-shop-top') != '' ) : ?>
					<div class="top-title-description">
						<p><?php echo nl2br(ivan_get_option('title-desc-shop-top')); ?></p>
					</div>
				<?php 
				endif;	
				?>

				<h1><?php echo ivan_get_option('title-text-shop'); ?></h1>
