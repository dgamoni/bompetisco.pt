...
<div class="col-wrapper-images">
	<div class="images">
		...
		<div class="single-product-main-images owl-carousel">
			<?php
				if ( has_post_thumbnail() ) {
					...
					$size = apply_filters('ivan_default_woo_img_size', 'shop_single');

					if(true == ivan_get_option('woo-thumbnail-stacked'))
						$size = apply_filters('ivan_default_woo_img_size', 'large');
					...
					if( $attachment_ids ) :
						...
						foreach ( $attachment_ids as $attachment_id ) {
							...
							$image = wp_get_attachment_image( $attachment_id, $size, array(
								'data-zoom-image' => $image_link
								) );
		...
		<?php 
		if( ivan_get_option('woo-product-disable-thumbs') == false ) :
